...
public class EditMultipleGroups {
	...
	public void runTest() throws InterruptedException {
		...
		assertTrue(driver.findElement(By.xpath(".//*[@id='content']/form[1]")).getText().contains("New Group1"));
		assertTrue(driver.findElement(By.xpath(".//*[@id='content']/form[1]")).getText().contains("New Group2"));
		assertTrue(driver.findElement(By.xpath(".//*[@id='content']/form[1]")).getText().contains("New Group3"));
