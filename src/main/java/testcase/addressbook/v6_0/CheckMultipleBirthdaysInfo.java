...
public class CheckMultipleBirthdaysInfo {
	...
	public void runTest() throws InterruptedException {
		...
		assertEquals("mail1@mail.it",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[2]/td[4]")).getText());
		assertEquals("01056321",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[2]/td[5]")).getText());
		...
		assertEquals("mail2@mail.it",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[3]/td[4]")).getText());
		assertEquals("01056322",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[3]/td[5]")).getText());
//		assertEquals("June",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[1]/th")).getText());
		...
		assertEquals("mail3@mail.it",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[4]/td[4]")).getText());
		assertEquals("01056323",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[4]/td[5]")).getText());
//		assertEquals("June",driver.findElement(By.xpath(".//*[@id='birthdays']/tbody/tr[1]/th")).getText());
	}
