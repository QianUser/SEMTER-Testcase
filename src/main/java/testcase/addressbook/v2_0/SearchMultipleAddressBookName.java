...
public class SearchMultipleAddressBookName {
	...
	public void runTest() throws InterruptedException {
		...
		assertEquals("Number of results: 3", driver.findElement(By.xpath("/html/body/table/tbody/tr[2]/td[3]/form[2]/b")).getText());
		...
		assertEquals("lastname2",driver.findElement(By.xpath("/html/body/table/tbody/tr[2]/td[3]/form[2]/table[1]/tbody/tr[2]/td[2]")).getText());
