...
public class EditMultipleAddressBook {
	...
	public void runTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/table/tbody/tr[2]/td[3]/form[2]/table/tbody/tr[2]/td[7]/i/a")).click();
		...
		driver.findElement(By.xpath("/html/body/table/tbody/tr[2]/td[3]/form[2]/table/tbody/tr[3]/td[7]/i/a")).click();
