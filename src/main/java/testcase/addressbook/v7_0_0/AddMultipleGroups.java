...
public class AddMultipleGroups {
	...
	public void runTest() throws InterruptedException {
		...
		assertTrue(driver.findElement(By.xpath(".//*[@id='content']/form[1]")).getText().contains("Group1"));
		assertTrue(driver.findElement(By.xpath(".//*[@id='content']/form[1]")).getText().contains("Group2"));
		assertTrue(driver.findElement(By.xpath(".//*[@id='content']/form[1]")).getText().contains("Group3"));
	}
