...
public class AddCourseExerciseQuestions {
	...
	public void runTest() throws InterruptedException{
		...
		assertEquals("Multiple choice (Unique answer)", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[1]/td[3]")).getText());
		assertEquals("True/False", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[2]/td[3]")).getText());
		assertEquals("Multiple choice (Multiple answers)", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[3]/td[3]")).getText());
