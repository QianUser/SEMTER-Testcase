...
public class AddCourse {
	...
	public void runTest() throws InterruptedException{
		...
		driver.findElement(By.id("title")).sendKeys("Math");
		driver.findElement(By.id("officialCode")).sendKeys("1");
		new Select(driver.findElement(By.id("category"))).selectByVisibleText("(SC) Sciences");
