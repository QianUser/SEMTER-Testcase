...
public class SearchUser {
	...
	public void runTest() throws InterruptedException{
		...
		assertEquals("Bert", driver.findElement(By.xpath("//*[@id='claroBody']/table[4]/tbody/tr/td[3]")).getText());  
		assertEquals("User", driver.findElement(By.xpath("//*[@id='claroBody']/table[4]/tbody/tr/td[6]")).getText());  
