...
public class AddCourseExerciseQuestions {
	...
	public void runTest() throws InterruptedException{
		...
		driver.findElement(By.name("answer_1")).click();
		driver.findElement(By.name("answer_1")).sendKeys("answer 1");
		driver.findElement(By.name("grade_1")).clear();
		driver.findElement(By.name("grade_1")).sendKeys("3");
		driver.findElement(By.name("answer_2")).click();
		driver.findElement(By.name("answer_2")).sendKeys("answer 2");
		...
		driver.findElement(By.linkText("Exercise : Exercise 1")).click();
		...
		driver.findElement(By.id("correct_1")).click();
		driver.findElement(By.name("answer_1")).click();
		driver.findElement(By.name("answer_1")).sendKeys("answer 3");
		driver.findElement(By.name("grade_1")).clear();
		driver.findElement(By.name("grade_1")).sendKeys("3");
		driver.findElement(By.name("answer_2")).click();
		driver.findElement(By.name("answer_2")).sendKeys("answer 4");
		driver.findElement(By.name("grade_2")).clear();
		driver.findElement(By.name("grade_2")).sendKeys("0");
		driver.findElement(By.name("answer_3")).click();
		driver.findElement(By.name("answer_3")).sendKeys("answer 5");
		...
		assertEquals("Question 1", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[1]/td[1]")).getText());
		assertEquals("Question 2", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[2]/td[1]")).getText());
		assertEquals("Question 3", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[3]/td[1]")).getText());
		assertEquals("Multiple choice (Unique answer)", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[1]/td[2]")).getText());
		assertEquals("True/False", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[2]/td[2]")).getText());
		assertEquals("Multiple choice (Multiple answers)", driver.findElement(By.xpath(".//*[@id='claroBody']/table/tbody/tr[3]/td[2]")).getText());
