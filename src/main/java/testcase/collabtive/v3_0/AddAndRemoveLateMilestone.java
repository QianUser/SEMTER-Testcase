...
public class AddAndRemoveLateMilestone {
	...
	public void runTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id='datepicker_miles']/table/tbody/tr[9]/td/a")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.id("lateMilestones_toggle")).click();
		Thread.sleep(2000);

		assertEquals("Milestone002", driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[2]/div/span/a")).getText());
		assertEquals("20.03.2020", driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[3]")).getText());
