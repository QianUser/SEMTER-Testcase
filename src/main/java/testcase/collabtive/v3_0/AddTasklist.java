...
public class AddTasklist {
	...
	public void runTest() throws InterruptedException {
		...
		driver.findElement(By.id("addtasklist")).click();
		Thread.sleep(2000);
		...
		assertEquals("Tasklist001", driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div/div/div[4]/div[1]/h2")).getText());
		...
		assertEquals("Tasklist001", driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[5]/div[2]/div/table/tbody/tr[2]/td/div/div/div/div[2]/ul/li/div/table/tbody/tr[2]/td/span/a")).getText());
