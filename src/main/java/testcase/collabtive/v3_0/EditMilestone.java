...
public class EditMilestone {
	...
	public void runTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id='datepicker_mile']/table/tbody/tr[9]/td/a")).click();
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("button[type='submit']")).click();
		Thread.sleep(1000);

		assertEquals("20.03.2024", driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[5]/div[2]/div/table/tbody/tr[1]/td[3]")).getText());
