...
public class SearchClosedProject {
	...
	public void runTest() throws InterruptedException {
		...
		driver.findElement(By.cssSelector("#sidebar-overlay > img")).click();
		...
		assertTrue(driver.findElement(By.tagName("body")).getText().contains("Project001"));
