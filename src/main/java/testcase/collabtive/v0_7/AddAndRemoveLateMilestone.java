...
public class AddAndRemoveLateMilestone {
	...
	public void runTest() throws InterruptedException {
		...
		assertEquals("Milestone002", driver.findElement(By.xpath("html/body/div[2]/div[2]/div[2]/div/div[1]/div[3]/div[2]/div[2]/table/tbody/tr[1]/td[2]/div/a")).getText());
		assertEquals("20.03.2020", driver.findElement(By.xpath("html/body/div[2]/div[2]/div[2]/div/div[1]/div[3]/div[2]/div[2]/table/tbody/tr[1]/td[3]")).getText());
