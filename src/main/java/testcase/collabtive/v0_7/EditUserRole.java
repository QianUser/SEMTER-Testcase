...
public class EditUserRole {
	...
	public void runTest() throws InterruptedException {
		...
		assertEquals("NewRole", driver.findElement(By.xpath("html/body/div[2]/div[2]/div[2]/div/div/div[1]/form/fieldset/table/tbody/tr/td[2]/div/div/table/tbody[23]/tr/td[2]/select/option[1]")).getText());
