...
public class RemoveMultipleProjects {
	...
	public void runTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("html/body/div[2]/div[2]/div[2]/div/div/div[3]/div[2]/table/tbody[1]/tr[1]/td[5]/a[2]")).click();
		Alert alert = driver.switchTo().alert();
		Thread.sleep(2000);
		alert.accept();


		driver.findElement(By.xpath("html/body/div[2]/div[2]/div[2]/div/div/div[3]/div[2]/table/tbody[2]/tr[1]/td[5]/a[2]")).click();
		alert = driver.switchTo().alert();
		Thread.sleep(2000);
		alert.accept();


		driver.findElement(By.xpath("html/body/div[2]/div[2]/div[2]/div/div/div[3]/div[2]/table/tbody[3]/tr[1]/td[5]/a[2]")).click();
		alert = driver.switchTo().alert();
		Thread.sleep(2000);
		alert.accept();
